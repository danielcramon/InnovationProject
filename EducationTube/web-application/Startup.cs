...
namespace web_application
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<EducationTubeContext>(options =>
                    options.UseSqlServer(
                        Configuration.GetConnectionString("EducationTubeContextConnection")));

            services.AddIdentity<EducationTubeUser, EducationTubeRole>()
                .AddEntityFrameworkStores<EducationTubeContext>()
